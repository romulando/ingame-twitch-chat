...
export const UpdateNotification = ({ onClose }) => {
  ...
  if (error && !updateInfo) {
    return _jsxs('div', {
      ...
      children: [
        _jsxs('div', {
          ...
          children: [
            _jsxs('div', {
              ...
              children: [
                _jsx(AlertCircle, { className: 'w-5 h-5' }),
                _jsx('span', {
                  className: 'font-medium',
                  children: 'Erro de Atualiza\u00E7\u00E3o'
                })
              ]
            }),
            _jsx('button', {
        ...
        _jsx('p', { className: 'mt-2 text-sm', children: error }),
        _jsx('button', {
  ...
  if (isUpdateDownloaded) {
    return _jsxs('div', {
      className:
        'fixed top-4 right-4 bg-green-500 text-white p-4 rounded-lg shadow-lg max-w-sm z-50',
      children: [
        _jsxs('div', {
          className: 'flex items-center justify-between',
          children: [
            _jsxs('div', {
              className: 'flex items-center space-x-2',
              children: [
                _jsx(CheckCircle, { className: 'w-5 h-5' }),
                _jsx('span', { className: 'font-medium', children: 'Atualiza\u00E7\u00E3o Pronta' })
              ]
            }),
            _jsx('button', {
              onClick: onClose,
        ...
        _jsx('p', {
          ...
          children:
            'A atualiza\u00E7\u00E3o foi baixada e est\u00E1 pronta para instala\u00E7\u00E3o.'
        }),
        _jsxs('div', {
  ...
  if (updateInfo) {
    return _jsxs('div', {
      className:
        'fixed top-4 right-4 bg-blue-500 text-white p-4 rounded-lg shadow-lg max-w-sm z-50',
      children: [
        _jsxs('div', {
          className: 'flex items-center justify-between',
          children: [
        ...
        _jsxs('p', {
          className: 'mt-2 text-sm',
          children: ['Nova vers\u00E3o ', updateInfo.version, ' est\u00E1 dispon\u00EDvel!']
        }),
        _jsx('p', {
          className: 'mt-1 text-xs opacity-75',
          children: '\u2728 Teste de atualiza\u00E7\u00E3o autom\u00E1tica - v1.0.1'
        }),
        isDownloading &&
          _jsxs('div', {
            className: 'mt-3',
            children: [
              _jsxs('div', {
                ...
                children: [
                  _jsx('span', { children: 'Baixando...' }),
                  _jsxs('span', { children: [Math.round(downloadProgress), '%'] })
                ]
              }),
              _jsx('div', {
                className: 'w-full bg-blue-600/30 rounded-full h-2',
                children: _jsx('div', {
  ...
  if (isChecking) {
    return _jsx('div', {
      className:
        'fixed top-4 right-4 bg-gray-500 text-white p-4 rounded-lg shadow-lg max-w-sm z-50',
      children: _jsxs('div', {
        className: 'flex items-center space-x-2',
        children: [
          _jsx('div', { className: 'animate-spin rounded-full h-4 w-4 border-b-2 border-white' }),
          _jsx('span', { className: 'text-sm', children: 'Verificando atualiza\u00E7\u00F5es...' })
        ]
      })
    })
  }
