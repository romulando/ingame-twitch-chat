...
export const Chat = () => {
    ...
    useEffect(() => {
        ...
        if (allChats.length > prevCountRef.current) {
            ...
            const hasUserMessage = newMessages.some((msg) => !['CONEXÃO', 'AJUDA'].includes(msg.author.name));
            if (hasUserMessage) {
